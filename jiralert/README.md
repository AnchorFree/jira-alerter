# JIRAlert [![Build Status](https://travis-ci.org/free/jiralert.svg)](https://travis-ci.org/free/jiralert) [![Go Report Card](https://goreportcard.com/badge/github.com/anchorfree/jira-alerter)](https://goreportcard.com/report/github.com/anchorfree/jira-alerter) [![GoDoc](https://godoc.org/github.com/anchorfree/jira-alerter?status.svg)](https://godoc.org/github.com/anchorfree/jira-alerter)
...
Get JIRAlert, either as a [packaged release](https://github.com/anchorfree/jira-alerter/releases) or build it yourself:

```
$ go get github.com/anchorfree/jira-alerter/cmd/jiralert
```
...
JIRAlert is licensed under the [MIT License](https://github.com/anchorfree/jira-alerter/blob/master/LICENSE).
